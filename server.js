...
app.get('/team_stats', function(req,res){
	...
	var winning = 'select * from football_games WHERE home_score > visitor_score;';
	var losing = 'select * from football_games WHERE home_score < visitor_score;';
	db.task('get-everything', task => {
    	return task.batch([
    	    task.any(allgames),
    	    task.any(winning),
...
app.get('/player_info',function(req,res){
	var play = "select * from football_players;";
	db.any(play)
	.then(data => {
...
app.get('/player_info/post', function(req,res){
	...
	var playerStats = "select * from football_players where id = "+ choice +";";
	var playerGames = "select COUNT(*) from football_games where ("+ choice +") = any(players);";
	db.task('get-everything', task => {
		return task.batch([
			task.any(player),
